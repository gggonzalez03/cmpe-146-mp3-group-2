...
typedef enum {
  ...
  MP3_CONTROLLER__TREBLE_UP,
  MP3_CONTROLLER__TREBLE_DOWN,
  MP3_CONTROLLER__BASS_UP,
  ...
  MP3_CONTROLLER__ORIENTATION_UP,
  MP3_CONTROLLER__ORIENTATION_DOWN,
  MP3_CONTROLLER__ORIENTATION_RIGHT,
  MP3_CONTROLLER__ORIENTATION_LEFT
